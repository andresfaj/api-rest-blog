...
blogController.postPublication = async(req, res) => {
    const { title, subtitle, body, category, userId, urlImage, comments } = req.body;
    const publication = new modelBlog({ title, subtitle, body, category, userId, urlImage, comments });
